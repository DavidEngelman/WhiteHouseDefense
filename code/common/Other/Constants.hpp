 ...
 */
static const int TRANSITIONS_TICKS_PER_STEP = TILES_SIZE;
static const int STEP_DURATION = 700;
static const int STEP_TRANSITION_DURATION = STEP_DURATION / TRANSITIONS_TICKS_PER_STEP;
static const int INTERVAL_BETWEEN_PNJS_IN_WAVE_IN_MS = STEP_DURATION;
static const int NUM_TICKS_BETWEEN_SHOOTS = TRANSITIONS_TICKS_PER_STEP;
static const int NUM_TICKS_BETWEEN_GOLD_EARNED = TRANSITIONS_TICKS_PER_STEP;
static const int INTERVAL_BETWEEN_SENDS_IN_MS = STEP_TRANSITION_DURATION * 2;
static const int INTERVAL_BETWEEN_TOWER_PHASE_SENDS_IN_MS = 100;
